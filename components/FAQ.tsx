    ...
    <section className="relative min-h-screen bg-dark pt-32 pb-16">
      ...
      <div className="relative max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          <Link href="/contact" className="px-6 py-2 rounded border border-white text-white font-semibold hover:bg-white hover:text-dark transition-colors">Contact</Link>
        </div>
      </div>
    </section>
  );
